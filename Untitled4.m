...
bnet.CPD{3} = gaussian_CPD(bnet, 3, 'mean', Y0_mean, 'cov', Cov_y0, 'weights', C, 'clamp_mean', 1,'cov_prior_weight', 0);
bnet.CPD{4} = gaussian_CPD(bnet, 5, 'mean', x1_mean, 'cov', Cov_x1, 'weights', X_weight, 'clamp_mean', 1,'cov_prior_weight', 0);
bnet.CPD{5} = gaussian_CPD(bnet, 6, 'mean', Y1_mean, 'cov', Cov_y1, 'weights', C, 'clamp_mean', 1,'cov_prior_weight', 0);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% 推断
T = 15; % 固定长度序列
clear engine;
